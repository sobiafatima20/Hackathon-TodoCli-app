...
app = FastAPI(
    title="TodoApp Task Management API",
    description="TodoApp - A comprehensive task management API with user authentication and isolation.",
    version="1.0.0",
    lifespan=lifespan,
    docs_url="/docs",
    redoc_url="/redoc"
...
async def root():
    ...
    return {
        "message": "Welcome to Task API Backend",
...
async def health_check():
    ...
    return {
        "status": "healthy",
        "message": "Task API Backend is running",

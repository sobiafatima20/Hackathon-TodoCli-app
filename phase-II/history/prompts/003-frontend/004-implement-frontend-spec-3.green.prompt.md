...
links:
  spec: phase-II/specs/003-frontend/spec.md
  ticket: null
  adr: null
  pr: null
files:
  ...
  - phase-II/frontend/src/app/(auth)/signin/page.tsx
  - phase-II/frontend/src/app/(auth)/signup/page.tsx
  - phase-II/frontend/src/app/(auth)/layout.tsx
  - phase-II/frontend/src/app/(dashboard)/tasks/page.tsx
  - phase-II/frontend/src/app/(dashboard)/tasks/create/page.tsx
  - phase-II/frontend/src/app/(dashboard)/tasks/[taskId]/page.tsx
  ...
  - phase-II/frontend/src/components/ui/TextArea.tsx
  - phase-II/frontend/src/components/ui/Checkbox.tsx
  - phase-II/frontend/src/components/ui/Modal.tsx
  ...
  - phase-II/frontend/src/components/tasks/TaskEmptyState.tsx
  - phase-II/frontend/src/lib/api/client.ts
  - phase-II/frontend/src/lib/api/auth.ts
  - phase-II/frontend/src/lib/api/tasks.ts
  - phase-II/frontend/src/lib/hooks/useAuth.ts
  - phase-II/frontend/src/lib/hooks/useTasks.ts
  - phase-II/frontend/src/lib/utils/validation.ts
  - phase-II/frontend/src/lib/utils/storage.ts
  - phase-II/frontend/src/types/auth.ts
  - phase-II/frontend/src/types/tasks.ts
  - phase-II/frontend/src/types/api.ts
  - phase-II/frontend/src/types/ui.ts
  - phase-II/frontend/src/context/AuthContext.tsx
  - phase-II/frontend/middleware.ts
  - phase-II/frontend/tailwind.config.ts
  - phase-II/frontend/jest.config.js
  - phase-II/frontend/jest.setup.js
  - phase-II/frontend/.env.local
  - phase-II/specs/003-frontend/tasks.md
tests:
